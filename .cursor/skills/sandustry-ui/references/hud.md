...
Version chip **v0.5.2**. This save: **MAX LEVEL**, viability bar.
...
**Debug** ([debug.md](debug.md)). Hidden while DEBUG is open.
...
**Menu [Esc]** ([pause.md](pause.md)). **Viability**. **Objectives** (story card). **SECONDARY** checklist.
...
Banks: [options.md](options.md) **Hotbars**. Keys: [bindings.md](bindings.md) HOTBAR.
