...
- Player mutators: `api.player.setWorldPosition`, `setVelocity`, `setMovementSpeedMultiplier`, `setMovementMode`, `teleportToGround`, `inventory.addFromId`, `buildings.unlockByType`.
