...
- **[React HUD](modkit/react.md)** — JSX via `sandkit.react`, plus the [UI kit](ui/README.md) and [gallery](ui/gallery.md).
...
| `npm run publish`   | Runs `build:release`, then SteamCMD upload                       |
