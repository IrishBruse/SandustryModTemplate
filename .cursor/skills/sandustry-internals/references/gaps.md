...
- Full `sandkit.api.*` method lists (use [SandustryTypes](https://sandustry-modding.github.io/SandustryTypes/#/); live namespace keys confirmed 2025-08 via MCP on page scope `sandkit.api`)
