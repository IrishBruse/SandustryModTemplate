...
- **Debug helpers** — companion mod `src/debug` (F12 DevTools, auto-load save, Start save picker in Options → Mods). [Debug](https://ethanconneely.com/SandustryModTemplate/#/modkit/debug)
