...
- **Debug companion** — mod `src/hot-reload` (DevTools, auto-load last save, F3). There is no in-game reload yet. `console` → file log is still an esbuild inject.
...
| Debug companion    | [debug.md](debug.md)                 |
