...
For paint-only registration, see [`custom-element`](../custom-element/).

## Copy this mod

Copy `examples/content/content-machine/` to `src/<your-mod>/`. Adjust element ids, sprite under `mod/`, shape, and processor logic in `main.ts`.
