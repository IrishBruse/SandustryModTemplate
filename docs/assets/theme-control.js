(function () {
  ...
  function apply() {
    ...
    document.documentElement.setAttribute("data-smt-docs-theme", resolvedTheme());
    if (!link) {
      return;
    }
    var mode = getMode();
  ...
  function updateButton(btn) {
    ...
    btn.setAttribute(
      "aria-label",
      "Color theme is " + mode + ". Activate to cycle system default, light, and dark.",
    );
  ...
  function syncSidebarToggleIcon() {
    var inner = document.querySelector(".sidebar-toggle .sidebar-toggle-button");
