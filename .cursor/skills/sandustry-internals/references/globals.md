...
| `__sandkitPickBlockInstant__` | Boolean (true in this session) |
...
## Template extras (this repo's session)

Not vanilla. Ignore when mapping the game:

- `__modkitManagementLayoutStops`
- `irishbruse.selection-capture:overlay`
