/**
 * Runtime maps on `sandkit.enums` (and the debug `enums` global).
 *
 * Paste a new dump into types/api/source/runtime-enums.json when the game enums change.
 */
...
export interface SandkitEnums {
  ...
  Tech: {
    ...
    50: "AlienCore";
    51: "Emanators1";
    52: "AlienPlasmaConduits";
    53: "AlienQuantumMatrix";
    54: "AlienPlasmaCore";
    55: "AlienVoidEngine";
    56: "FlareGun";
    57: "Sweeper";
...
/** Value stored on `sandkit.enums[K][name]`. Tech also has numeric reverse keys. */
export type SandkitEnumValue<K extends keyof SandkitEnums> = SandkitEnums[K][keyof SandkitEnums[K]];
