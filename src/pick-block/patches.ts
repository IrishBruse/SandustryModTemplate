...
export const PICKER_DOWN_CODE =
  "down:e=>{_S=!0;if(globalThis.__sandkitPickBlockInstant__){e.session.input.mouse.clicked=!0;const t=e.sandkit.keyBindings.Picker.handlers;t.pressed&&t.pressed(e)}}";
